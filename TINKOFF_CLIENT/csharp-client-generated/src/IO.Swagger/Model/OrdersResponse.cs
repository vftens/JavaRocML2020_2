...
namespace IO.Swagger.Model
{
        ...
        public partial class OrdersResponse :  IEquatable<OrdersResponse>, IValidatableObject
    {
        ...
        public OrdersResponse(string trackingId = default(string), string status = "Ok", List<Order> payload = default(List<Order>))
        {
            // to ensure "trackingId" is required (not null)
            if (trackingId == null)
            {
                throw new InvalidDataException("trackingId is a required property for OrdersResponse and cannot be null");
            }
            else
            {
            ...
            if (status == null)
            {
                throw new InvalidDataException("status is a required property for OrdersResponse and cannot be null");
            }
            else
            {
                this.Status = status;
            ...
            if (payload == null)
            {
                throw new InvalidDataException("payload is a required property for OrdersResponse and cannot be null");
            }
            else
            {
