...
final public class Settings {
    ...
    public static final String SAVE_FILE_EXTENSION = "rus"; //"fes";
    public static final File FONT_ROBOTO_LIGHT = new File("fonts/Roboto-Light.ttf");
    public static final File SAVE_DIR = new File("saves/");
    public static final String SAVE_FILE_EXT =  SAVE_FILE_EXTENSION ;
    ...
    private static File FILE_SAVE = new File("saves/default.rus"); //fes");
